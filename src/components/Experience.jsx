...
const experiences = [
  {
    ...
    responsibilities: [
      'Developed a 3D Jewellery Rendering full-stack web application using React.js , Three.js and Node.js to work within both online and offline modes',
      'Collaborated with cross-functional teams on real-world production projects deployed on the Linux Server',
      'Built scalable, reusable component libraries improving development speed by 40% along with css variable reusablity',
  ...
  },
  {
    ...
    responsibilities: [
      'Built an e-commerce website — a full-featured e-commerce platform with MERN stack',
      ...
      'Delivered responsive, perfect UI components from Figma designs',
    ],
    tech: ['React.js','Tailwind CSS' , 'MongoDB', 'Express', 'Node.js', 'Figma'],
  },
  {
    company: 'CodSoft',
